...
public class NextXAVA : NextPosition
{
    [JsonPropertyName("velocity")]
    public int Velocity { get; init; }

    /// <param name="position">Absolute position in millimeter (mm).</param>
    ...
    public NextXAVA(double position, int velocity, bool stopOnTarget, bool immediateResponse)
        : base(position, stopOnTarget, immediateResponse)
        => Velocity = velocity;
}
